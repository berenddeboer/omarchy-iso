...
# live initramfs.
arch_packages=(linux-t2 linux-t2-headers git gum jq openssl plymouth ttfx tzupdate omarchy-keyring "$OMARCHY_SETTINGS_PACKAGE" lvm2 cryptsetup parted gptfdisk dkms zfs-utils zfs-dkms)
